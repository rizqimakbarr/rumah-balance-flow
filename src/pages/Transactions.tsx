  ...
  const handleAddOrUpdate = async (tx: any) => {
    ...
    try {
      ...
      if (editData) {
        ...
        // Create new transaction with UUID generated by Supabase
      ...
      // Update savings goals if the transaction category matches a savings goal
